...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen pt-24 pb-16 overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-paw-peach rounded-full blur-3xl opacity-50" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-paw-cream rounded-full blur-3xl opacity-60" />
