        ...
        <div className="relative flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex items-center gap-2 pt-2">
              <Shield className="w-4 h-4 text-woofy-light/80" />
              <span className="text-sm text-woofy-light/80">Valid until: <strong>{expiryDate}</strong></span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-woofy-light/60 mt-2 text-center">Scan to verify</p>
          </div>
        </div>
