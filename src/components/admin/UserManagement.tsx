        ...
        <CardContent>
          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as UserCategory)} className="w-full">
            <TabsList className="flex flex-wrap gap-1 h-auto p-1 mb-4 w-full justify-start">
              ...
              <TabsTrigger value="members" className="text-xs sm:text-sm px-3 py-1.5 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Members ({counts.members})</TabsTrigger>
