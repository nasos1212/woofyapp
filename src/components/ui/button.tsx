  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:scale-105 shadow-glow hover:shadow-lg transition-all duration-300",
        heroOutline: "border-2 border-primary text-primary bg-card/50 backdrop-blur-sm hover:bg-primary hover:text-primary-foreground transition-all duration-300",
        warm: "bg-paw-cream text-paw-brown hover:bg-paw-peach transition-all duration-300",
      },
      size: {
