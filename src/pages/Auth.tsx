    ...
    try {
      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          // No toast needed — the /verify-email page shows full "Check Your Email" instructions
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl shadow-card p-8">
          ...
          {(isLogin || accountType === "member") && (
            <>
              {/* Sign in with Apple — hidden until custom Apple Developer credentials are configured.
                  To re-enable: unwrap this block. Backend provider is already enabled. */}
              {false && (
                <div className="space-y-2 mb-4">
                  ...
                  >
                    ...
                    {isLogin ? t("common.signInWithApple") : t("common.signUpWithApple")}
                  </Button>
                </div>
              )}
              ...
              <div className="space-y-2 mb-4">
                ...
                >
                  ...
                  {isLogin ? t("common.signInWithGoogle") : t("common.signUpWithGoogle")}
                </Button>
