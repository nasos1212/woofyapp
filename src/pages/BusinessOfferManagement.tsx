  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
        ...
        <main className="container mx-auto px-4 py-8 pt-[calc(6rem+env(safe-area-inset-top))] md:pt-[calc(7rem+env(safe-area-inset-top))] max-w-4xl">
          <Button
            variant="ghost"
            size="sm"
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-lg max-h-[85vh] md:max-h-[90vh] flex flex-col overflow-hidden w-[calc(100vw-2rem)] sm:w-full p-4 sm:p-6">
          ...
          <div className="space-y-4 py-4 overflow-y-auto overflow-x-hidden flex-1 min-h-0 pl-1 pr-6 [scrollbar-gutter:stable] sm:pl-0 sm:pr-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="text-base focus-visible:ring-inset focus-visible:ring-offset-0"
              />
              {!formData.title.trim() && (
