    ...
    try {
      ...
      if (user) {
        ...
        const { data: ownerCheck } = await supabase
          .from("businesses")
          .select("id, user_id, business_name, description, category, categories, phone, email, address, city, website, logo_url, google_maps_url, instagram_url, facebook_url, tiktok_url, verification_status, verified_at, created_at, updated_at")
          .eq("id", id)
          .eq("user_id", user.id)
          .maybeSingle();
