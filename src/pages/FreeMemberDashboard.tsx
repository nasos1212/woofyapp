    ...
    <>
      ...
      <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <main className="w-full max-w-7xl mx-auto px-4 py-8 pt-[calc(6rem+env(safe-area-inset-top))] box-border">
          ...
          <Card className="relative mb-8 overflow-hidden border-border shadow-card bg-card">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {pets.map((pet) => (
                    <button
                      ...
                      className="text-left rounded-xl border border-border bg-background hover:bg-muted/40 hover:shadow-md hover:border-primary/40 transition-all p-4 flex items-center gap-4"
                    >
                      {pet.photo_url ? (
                        <img
                          src={pet.photo_url}
