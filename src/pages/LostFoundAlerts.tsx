        ...
        <main className="w-full max-w-7xl mx-auto px-4 py-8 pt-[calc(6rem+env(safe-area-inset-top))] box-border">
                    ...
                    <div className="space-y-2">
                      <Label>{alertType === "lost" ? t("lostFound.form.lastSeenDate") : t("lostFound.form.dateFound")}</Label>
                       <Input
                          ...
                          required
                          className="w-full h-10 text-left [&::-webkit-date-and-time-value]:text-left [&::-webkit-date-and-time-value]:min-h-0 appearance-none"
                        />
                     </div>
          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)} className="space-y-6">
            <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 h-auto">
              ...
              <TabsTrigger value="reunited" className="gap-1.5 text-xs sm:text-sm px-1 sm:px-3 py-2 whitespace-normal leading-tight col-span-2 sm:col-span-1">
