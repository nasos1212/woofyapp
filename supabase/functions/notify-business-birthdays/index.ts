...
<p style="font-size: 18px; color: #1f2937; margin-bottom: 20px;">Hi ${businessData.business_name},</p>
<p style="font-size: 16px; color: #4b5563; line-height: 1.6; margin-bottom: 20px;">${notificationMessage}</p>
<div style="background-color: #E0F2FE; border-radius: 8px; padding: 16px; margin-bottom: 20px; border-left: 4px solid #7DD3FC;">
<p style="font-size: 16px; color: #1A1A2E; margin: 0;"><strong>🐕 ${pet.pet_name}</strong><br/>${pet.pet_breed || 'Pet'} • Turning ${age} years old</p>
</div>
<div style="text-align: center; margin: 30px 0;">
<a href="https://www.wooffy.app/business/birthdays" style="display: inline-block; background: linear-gradient(135deg, #1A1A2E 0%, #2D2D44 100%); color: #7DD3FC; text-decoration: none; padding: 14px 30px; border-radius: 8px; font-weight: 600; font-size: 16px;">Send Birthday Offer</a>
</div>
<p style="font-size: 14px; color: #6b7280; text-align: center;">Birthday offers help build customer loyalty and increase repeat visits!</p>
</div>
