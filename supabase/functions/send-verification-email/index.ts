            ...
            <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <div style="padding: 40px;">
                ...
                <p style="font-size: 16px; color: #4b5563; line-height: 1.6; margin-bottom: 20px;">
                  Thanks for signing up for Wooffy! Please click the button below to verify your email address and complete your registration.
                </p>
                <div style="text-align: center; margin: 30px 0;">
                  <a href="${verifyUrl}" style="display: inline-block; background: linear-gradient(135deg, #1A1A2E 0%, #2D2D44 100%); color: #7DD3FC; text-decoration: none; padding: 14px 30px; border-radius: 8px; font-weight: 600; font-size: 16px;">
                ...
                <p style="font-size: 14px; color: #6b7280; line-height: 1.6;">
                  If you didn't create an account on Wooffy, you can safely ignore this email.
                </p>
              </div>
